...
// text
- (void)UUInputFunctionViewMethod:(UUInputFunctionView *)funcView sendMessage:(NSString *)message;

// image
- (void)UUInputFunctionViewMethod:(UUInputFunctionView *)funcView sendPicture:(UIImage *)image;

// audio
- (void)UUInputFunctionViewMethod:(UUInputFunctionView *)funcView sendVoice:(NSData *)voice time:(NSInteger)second;
