//
//  PhotoBrowserlViewController.swift
//  Lolita-public
//
...
class PhotoBrowserlViewController: UIViewController {
    ...
    /// 类方法创建控制器
    class func photoBrowserViewController() ->PhotoBrowserlViewController {
        let sb = UIStoryboard(name: "PhotoBrowser", bundle: nil)
        let vc = sb.instantiateInitialViewController() as! PhotoBrowserlViewController
...
/// collection的数据源方法
extension PhotoBrowserlViewController:UICollectionViewDataSource {
